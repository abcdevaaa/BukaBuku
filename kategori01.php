...
<body>
        ...
        <div class="container">
            <nav class="navbar">
                ...
                <div class="navbar-left">
                    <div class="category-dropdown">
                        ...
                        <div class="category-menu">
                            <a href="j_fiksi.html">Buku Fiksi</a>
                            <a href="j_nonfiksi.html">Buku Nonfiksi</a>
                            <a href="j_anak.html">Buku Anak</a>
                            <a href="j_pelajaran.html">Buku Pelajaran</a>
                            <a href="j_agama.html">Buku Agama</a>
                            <a href="j_sejarah.html">Buku Sejarah</a>
                            <a href="j_komik.html">Komik</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="navbar-right">
                    ...
                    <div class="login">
                        <p class="btn-masuk">Masuk</p>
                        <p class="btn-daftar">Daftar</p>
                    </div>
                </div>
            </nav>
        </div>
    ...
    <div class="breadcrumb">
        <a href="before.php">Beranda</a>
        <span>/</span>
        <a href="kategori01.php" class="active"><?= $kategori['nama_kategori']; ?></a>
    </div>
