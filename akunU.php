            ...
            <div class="sidebar">
                ...
                <div class="sidebar-section">
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="wishlish.php">Wishlist</a></li>
            ...
            <div class="content">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" value="<?= $_SESSION['username'] ?>">
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="password" id="password" value="<?= $_SESSION['password'] ?>">
                    </div> -->
...
document.addEventListener('DOMContentLoaded', function() {
    // Ambil data profil dari halaman
    const profileName = document.querySelector('.profile-info h2')?.textContent || 'Adelia';
    const profileEmail = document.querySelector('.profile-info p')?.textContent || 'adeliasa@gmail.com';
    
    // Update dropdown profile dengan data yang sama
    const profileDropdownName = document.querySelector('.profile-name');
    const profileDropdownEmail = document.querySelector('.profile-email');
    
    if (profileDropdownName) profileDropdownName.textContent = profileName;
    if (profileDropdownEmail) profileDropdownEmail.textContent = profileEmail;
    ...
    const profileForm = document.querySelector('.content form');
    if (profileForm) {
        profileForm.addEventListener('submit', function(e) {
            ...
            // Update data di dropdown profile juga
            ...
            // Update data di header profile
            const profileHeaderName = document.querySelector('.profile-info h2');
            const profileHeaderEmail = document.querySelector('.profile-info p');
            if (profileHeaderName) profileHeaderName.textContent = fullname;
            if (profileHeaderEmail) profileHeaderEmail.textContent = email;
            
            // Jika validasi berhasil
            alert('Perubahan berhasil disimpan!');
            // Di sini biasanya ada AJAX request untuk menyimpan ke server
        });
    }
    ...
    // Tutup dropdown saat resize (untuk mobile)
